...
-----------------------
All the configuration variables are passed as environment variables. 

| Parameter                                           | Required                       | Description                                                                                                                                                   | Default value |
|-----------------------------------------------------|--------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------|
| FIREBOLT_OTEL_EXPORTER_CLIENT_ID                    | Yes                            | Client ID derived from the Service Account                                                                                                                    |               |
| FIREBOLT_OTEL_EXPORTER_CLIENT_SECRET                | Yes                            | Client Secret derived from the Service Account                                                                                                                |               |
| FIREBOLT_OTEL_EXPORTER_ACCOUNTS                     | Yes                            | List of accounts to monitor. The Service Account needs to have access to all theseaccounts to be able to fetch metrics data. At least one account is required |               |
| FIREBOLT_OTEL_EXPORTER_COLLECT_INTERVAL             | No                             | Defines how often metrics will be collected. Ninimal allowed value is 15s                                                                                     | `30s`         |
| FIREBOLT_OTEL_EXPORTER_LOG_FORMAT                   | No                             | Log format, either `json` or `text`                                                                                                                           | `json`        |
| FIREBOLT_OTEL_EXPORTER_LOG_LEVEL                    | No                             | Log level, one of `debug`, `info`, `error`                                                                                                                    | `info`        |
| FIREBOLT_OTEL_EXPORTER_GRPC_ADDRESS                 | Yes, if GRPC collector is used | GRPC address of collector, where metrics will be pushed, for example `127.0.0.1:4317`                                                                         |               |
| FIREBOLT_OTEL_EXPORTER_HTTP_ADDRESS                 | Yes, if HTTP collector is used | HTTP address of collector, where metrics will be pushed, for example `127.0.0.1:4318`                                                                         |               |
| FIREBOLT_OTEL_EXPORTER_GRPC_OAUTH_CLIENT_ID         | No                             | OAuth2 client id                                                                                                                                              |               |
| FIREBOLT_OTEL_EXPORTER_GRPC_OAUTH_CLIENT_SECRET     | No                             | OAuth2 client secret                                                                                                                                          |               |
| FIREBOLT_OTEL_EXPORTER_GRPC_OAUTH_TOKEN_URL         | No                             | OAuth2 resource server's token endpoint URL                                                                                                                   |               |
| FIREBOLT_OTEL_EXPORTER_SYSTEM_CERT_POOL             | No                             | Enables TLS security based on operating system certificate pool (`true` or `false`)                                                                           | `false`       |
| FIREBOLT_OTEL_EXPORTER_HTTP_TLS_X509_CERT_PEM_BLOCK | No                             | Specifies TLS certificate PEM in case HTTP mTLS authentication is used                                                                                        |               |
| FIREBOLT_OTEL_EXPORTER_HTTP_TLS_X509_KEY_PEM_BLOCK  | No                             | Specifies TLS key PEM in case HTTP mTLS authentication is used                                                                                                |               |
